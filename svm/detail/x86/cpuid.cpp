...
#error "Unsupported compiler"
	...
	cpuid::cpuid() noexcept
	{
		...
		if (test_bit(m_flags_l1_ecx, xsave_bit))
		{
			const auto xcr0 = platrofm_xcr0();

			const bool sse_mask = xcr0 & 0x2;
			mask_bit(m_flags_l1_edx, sse_bit, sse_mask);
			mask_bit(m_flags_l1_edx, sse2_bit, sse_mask);
			mask_bit(m_flags_l1_ecx, sse3_bit, sse_mask);
			mask_bit(m_flags_l1_ecx, ssse3_bit, sse_mask);
			mask_bit(m_flags_l1_ecx, sse4_1_bit, sse_mask);
			mask_bit(m_flags_l1_ecx, sse4_2_bit, sse_mask);

			const bool avx_mask = (xcr0 & 0x6) == 0x6;
			mask_bit(m_flags_l1_ecx, avx_bit, avx_mask);
			mask_bit(m_flags_l7_ebx, avx2_bit, avx_mask);
			mask_bit(m_flags_l1_ecx, fma_bit, avx_mask);
			...
			mask_bit(m_flags_l7_ebx, avx512f_bit, avx512_mask);
			mask_bit(m_flags_l7_ebx, avx512cd_bit, avx512_mask);
			mask_bit(m_flags_l7_ebx, avx512bw_bit, avx512_mask);
			mask_bit(m_flags_l7_ebx, avx512dq_bit, avx512_mask);
			mask_bit(m_flags_l7_ebx, avx512vl_bit, avx512_mask);
		}
		else
		{
			bool sse_mask = false;
...
#error "Unsupported OS"
			...
			mask_bit(m_flags_l1_edx, sse_bit, sse_mask);
			mask_bit(m_flags_l1_edx, sse2_bit, sse2_mask);
			mask_bit(m_flags_l1_ecx, sse3_bit, sse3_mask);
			mask_bit(m_flags_l1_ecx, ssse3_bit, ssse3_mask);
			mask_bit(m_flags_l1_ecx, sse4_1_bit, sse4_1_mask);
			mask_bit(m_flags_l1_ecx, sse4_2_bit, sse4_2_mask);
		}
	}

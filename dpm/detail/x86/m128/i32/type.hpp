...
namespace dpm
{
	...
	{
		template<detail::integral_of_size<4> I, std::size_t N, std::size_t Align> requires detail::overload_128<I, N, Align>
	...
	namespace detail
	{
		template<detail::integral_of_size<4> I, std::size_t N, std::size_t A> requires detail::overload_128<I, N, A>

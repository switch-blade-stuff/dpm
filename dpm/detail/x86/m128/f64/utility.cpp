...
namespace dpm::detail
{
	...
	__m128d x86_floor_f64(__m128d x) noexcept
	{
	...
	/* NOTE: Dynamic dispatch is not worth it for these. */
	__m128i x86_cvt_f64_u64(__m128d x) noexcept
	{
	...
	__m128i x86_cvt_f64_i64(__m128d x) noexcept
	{
	...
	__m128d x86_cvt_u64_f64(__m128i x) noexcept
	{
	...
	__m128d x86_cvt_i64_f64(__m128i x) noexcept
	{

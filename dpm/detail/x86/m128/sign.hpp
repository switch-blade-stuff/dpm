...
namespace dpm
{
	...
	namespace detail
	{
		...
		[[nodiscard]] inline __m128d x86_masksign(__m128d x) noexcept { return _mm_and_pd(x, _mm_set1_pd(-0.0)); }
	...
	namespace detail
	{
		...
		[[nodiscard]] inline __m128 x86_masksign(__m128 x) noexcept { return _mm_and_ps(x, _mm_set1_ps(-0.0f)); }
